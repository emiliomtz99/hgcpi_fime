...
(empleo_actual,institucion,dependencia,unidad_academica,fecha_inicio,fecha_fin,cronologia,usuario_idusuario) /* campos de destino, en el MISMO ORDEN que aparecen en la base de datos */
VALUES ('$empleo_actual','$institucion','$dependencia','$unidad_academica','$fecha_inicio','$fecha_fin', '$cronologia','$idusuario')"; /* valores a insertar en los campos de destino */
